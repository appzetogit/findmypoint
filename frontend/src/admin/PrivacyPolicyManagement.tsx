...
export default function PrivacyPolicyManagement() {
  ...
  const [modalIcon, setModalIcon] = useState<"lock" | "cookie" | "globe" | "alert">("lock");
  ...
  const getIconComponent = (icon: string) => {
    switch (icon) {
      case "lock":
        return <Lock className="h-3.5 w-3.5 text-indigo-500" />;
      case "cookie":
        return <Cookie className="h-3.5 w-3.5 text-indigo-500" />;
      case "globe":
    ...
    <div className="space-y-6 w-full animate-fade-in-up text-left relative">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
              Configure sections, cookie terms, and data collection disclosures
            </p>
          </div>
        </div>
      ...
      {isSavedAlert && (
        <div className="bg-emerald-50 dark:bg-emerald-950/20 border border-emerald-250 dark:border-emerald-900/50 text-emerald-700 dark:text-emerald-400 p-4 rounded-xl flex items-center gap-2.5 text-xs font-bold animate-fade-in">
          ...
          <span>Privacy Policy configuration saved successfully! (Ready to integrate)</span>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800/60 rounded-3xl p-6 md:p-8 shadow-sm space-y-6">
          ...
          <button
            ...
            className="w-full bg-indigo-600 hover:bg-indigo-700 disabled:bg-slate-200 dark:disabled:bg-slate-800 disabled:text-slate-450 dark:disabled:text-slate-650 font-bold py-3 rounded-xl shadow-md hover:shadow-lg flex items-center justify-center gap-2 transition duration-200 cursor-pointer text-xs"
          >
            ...
            >
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  placeholder="e.g. 1. Data Collected"
              ...
              <div className="space-y-1.5">
                ...
                <div className="grid grid-cols-4 gap-3">
                  {[
                    ...
                    {
                      value: "cookie",
                      icon: <Cookie className="h-4 w-4 text-indigo-500" />,
                      label: "Cookies",
                    },
                    {
                      value: "globe",
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  placeholder="Enter details and descriptions for this policy section..."
