...
export default function ProfileWizard({ onClose, username }: ProfileWizardProps) {
  const [state, dispatch] = useReducer(
    profileWizardReducer,
    initialProfileWizardState(username || ""),
  );
  const {
    step,
    personal,
  ...
  const mockVerifyMobile = () => {
    if (!personal.mobile2) {
      alert("Please enter WhatsApp Number to verify.");
      return;
    }
    ...
    <div className="fixed inset-0 z-50 bg-slate-50 flex flex-col md:flex-row w-full h-full text-left overflow-hidden animate-fade-in">
      ...
      <aside className="w-full md:w-80 bg-gradient-to-b from-primary to-indigo-950 p-5 md:p-8 text-primary-foreground flex flex-col justify-between shrink-0 border-r border-border/10 relative">
        <div>
          ...
          <h2 className="font-serif text-2xl font-black mt-1 leading-tight tracking-tight uppercase">
            Fill Profile
          </h2>
            ...
            {[
              ...
              return (
                <div key={item.s} className="relative flex items-start gap-4">
                  ...
                  {item.s < 4 && (
                    <div
                      className={`absolute left-4.5 top-9 w-[2px] h-9 -ml-[1px] transition-colors duration-300 ${step > item.s ? "bg-accent" : "bg-white/20"}`}
                    />
                  )}
                  ...
                  <div className="flex flex-col text-left">
                    <span
                      className={`text-[13px] font-bold leading-tight ${isActive ? "text-white" : isCompleted ? "text-accent" : "text-white/60"}`}
                    >
                      {item.label}
                    </span>
                    <span
                      className={`text-[10px] font-medium leading-relaxed mt-0.5 ${isActive ? "text-white/80" : "text-white/40"}`}
                    >
                      {item.desc}
                    </span>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-3 gap-3.5">
                      <select
                        ...
                        onChange={(e) =>
                          dispatch({ type: "UPDATE_PERSONAL", fields: { dobDD: e.target.value } })
                        }
                        className="w-full rounded-xl border border-border bg-background px-3 py-2.5 text-xs font-semibold outline-none focus:border-accent"
                      >
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          dispatch({ type: "UPDATE_PERSONAL", fields: { dobMM: e.target.value } })
                        }
                        className="w-full rounded-xl border border-border bg-background px-3 py-2.5 text-xs font-semibold outline-none focus:border-accent"
                      >
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          dispatch({ type: "UPDATE_PERSONAL", fields: { dobYYYY: e.target.value } })
                        }
                        className="w-full rounded-xl border border-border bg-background px-3 py-2.5 text-xs font-semibold outline-none focus:border-accent"
                      >
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          dispatch({
                            type: "UPDATE_PERSONAL",
                            fields: { maritalStatus: e.target.value },
                          })
                        }
                        className="w-full rounded-xl border border-border bg-background px-3.5 py-2.5 text-xs font-semibold outline-none focus:border-accent"
                      >
                ...
                <div className="lg:col-span-4 space-y-5 text-center flex flex-col items-center">
                  ...
                  <div className="w-full text-left space-y-3 pt-2">
                    <div>
                      <label
                        htmlFor="profileMobile1"
                        className="block text-[10px] font-black uppercase text-muted-foreground tracking-wider mb-1"
                      >
                        Mobile Number 1
                      </label>
                      <div className="relative flex">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            dispatch({
                              type: "UPDATE_PERSONAL",
                              fields: { mobile1: e.target.value.replace(/[^0-9]/g, "") },
                            })
                          }
                        ...
                        <div className="relative flex flex-1">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              dispatch({
                                type: "UPDATE_PERSONAL",
                                fields: { mobile2: e.target.value.replace(/[^0-9]/g, "") },
                              })
                            }
                ...
                <div className="lg:col-span-7 bg-secondary/25 border border-border/80 rounded-2xl p-5 space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={newAddr.email}
                      onChange={(e) =>
                        dispatch({ type: "UPDATE_NEW_ADDR", fields: { email: e.target.value } })
                      }
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    <div className="col-span-2">
                      ...
                      <input
                        ...
                        value={newAddr.city}
                        onChange={(e) =>
                          dispatch({ type: "UPDATE_NEW_ADDR", fields: { city: e.target.value } })
                        }
                        placeholder="City"
                        className="w-full rounded-xl border border-border bg-background px-3.5 py-2.5 text-xs font-semibold outline-none focus:border-accent"
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          dispatch({ type: "UPDATE_NEW_ADDR", fields: { pincode: e.target.value } })
                        }
                        placeholder="Pincode"
                        className="w-full rounded-xl border border-border bg-background px-3.5 py-2.5 text-xs font-semibold outline-none focus:border-accent"
                      />
                  ...
                  <div className="grid grid-cols-12 gap-3 items-end">
                      ...
                      <div className="flex gap-1.5">
                        <input
                          ...
                          onChange={(e) =>
                            dispatch({
                              type: "UPDATE_NEW_ADDR",
                              fields: { landlineStd: e.target.value.replace(/[^0-9]/g, "") },
                            })
                          }
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            dispatch({
                              type: "UPDATE_NEW_ADDR",
                              fields: { landlineNum: e.target.value.replace(/[^0-9]/g, "") },
                            })
                          }
                    ...
                    <div className="col-span-4">
                      ...
                      <select
                        ...
                        value={newAddr.tag}
                        onChange={(e) =>
                          dispatch({ type: "UPDATE_NEW_ADDR", fields: { tag: e.target.value } })
                        }
                        className="w-full rounded-xl border border-border bg-background px-3 py-2.5 text-xs font-semibold outline-none focus:border-accent"
                      >
                  ...
                  {addresses.length === 0 ? (
                    ...
                    <div className="space-y-3 max-h-[300px] overflow-y-auto pr-1 no-scrollbar">
                      {addresses.map((item) => (
                        <div
                          key={item.id}
                          className="bg-card border border-border rounded-xl p-4.5 shadow-sm text-left relative group"
                        >
                          <button
                          ...
                          <div className="flex items-center gap-2">
                            <span className="text-[10px] font-black uppercase px-2 py-0.5 rounded bg-primary/10 text-primary border border-primary/15">
                              {item.tag}
                            </span>
            ...
            <div className="py-8 text-center flex flex-col items-center max-w-lg mx-auto justify-center my-auto animate-fade-in">
              ...
              <div className="w-full bg-secondary/35 border border-border/75 rounded-2xl p-5 text-left space-y-4 mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="text-[10px] font-black uppercase text-muted-foreground block tracking-wider leading-none">
                      Verified Member
                    </span>
                ...
                <div className="grid grid-cols-2 gap-4 text-xs">
                  <div>
                    ...
                    <span className="font-bold text-foreground/90 mt-0.5 block">
                      +91 {personal.mobile1}
                    </span>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <span className="font-bold text-foreground/90 mt-0.5 block">
                      {addresses.length} Node{addresses.length > 1 ? "s" : ""} saved
                    </span>
                  </div>
                  <div>
                    <span className="text-[9px] font-black uppercase text-muted-foreground block">
