...
export const businessesData: BusinessListingData[] = [
  {
    ...
    reviews: [
      ...
      },
      {
        ...
        rating: 4,
        date: "12 May 2026",
        reviewText: "Great discount on home utilities and groceries. The billing lines can get long on Sunday evenings, but the staff handles it well. Extremely cost-effective!"
      },
      {
        ...
        rating: 5,
        date: "18 Apr 2026",
        reviewText: "Excellent parking space, friendly helpers, and clean sections. They have a massive apparel section which is surprisingly fashionable for the price!"
      }
    ],
    faqs: [
      {
        question: "Does Vishal Mega Mart South Tukoganj have home delivery?",
        answer: "Yes, they provide home delivery for orders above ₹999 within a 5km radius. You can also place orders via their official app."
      },
      {
        question: "What are the accepted payment methods?",
        answer: "They accept cash, credit cards, debit cards, UPI payments (Paytm, Google Pay, PhonePe), and Sodexo meal coupons."
      },
      {
        question: "Is parking available at this location?",
        answer: "Yes, there is free underground and street-level parking available for two-wheelers and four-wheelers."
      }
    ],
    similarListings: [
      {
  ...
  },
  {
    ...
    description: "Sunny Chilled Water is the most trusted bulk RO and mineral water provider in Nandlalpura and surrounding residential areas in Indore. They supply high-quality reverse osmosis filtered water chilled to perfection, perfect for corporate events, wedding parties, or daily domestic consumption.",
    products: [
      {
    ...
    reviews: [
      ...
      },
      {
        ...
        rating: 5,
        date: "05 Jun 2026",
        reviewText: "I've been ordering daily drinking water cans from Sunny Water for over two years now. The water is clean, has a sweet natural taste, and delivery is never delayed!"
      }
    ],
    faqs: [
      {
        question: "What is the minimum order quantity for home delivery?",
        answer: "The minimum order quantity for free delivery in Nandlalpura is 2 water cans (20L). For smaller quantities, a small transit fee of ₹10 applies."
      },
      {
        question: "Do you supply water for large-scale wedding events?",
        answer: "Yes! We specialize in bulk event supply. We can deliver up to 500 cans and 200 boxes of bottled water. Please reserve 3 days in advance."
      }
    ],
    similarListings: [
      {
  ...
  },
  {
    ...
    description: "Riya Chilled Water offers premium reverse osmosis water filtration services. Centrally located near Agrasen Square, they have delivery vans available 24/7 to supply chilled and normal drinking water cans to restaurants, cafes, hostels, and residential clients.",
    products: [
      {
    ...
    reviews: [
      ...
      },
      {
        ...
        rating: 4.5,
        date: "02 Jun 2026",
        reviewText: "Very reasonable pricing and quick service. Cans are washed and sanitized, which is a major hygiene plus. Keep it up!"
      }
    ],
    faqs: [
      {
        question: "Is there a refund on the empty can deposit?",
        answer: "Yes, there is a refundable deposit of ₹150 per can if you do not have an empty can to swap."
      }
    ],
    similarListings: [
      {
...
export function getBusinessesForSubcategory(category: string, subcategory: string): BusinessListingData[] {
  ...
  for (let i = 0; i < 4; i++) {
    ...
    const item: BusinessListingData = {
      ...
      description: desc,
      products: isFood ? foodProducts[i] : (
        category === "Hotel Point" ? [
          ...
          category === "Health Care Point" && (subcategory === "Doctors" || subcategory === "Dentists" || subcategory === "Clinics") ? [
            {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer: "We are open from 09:30 AM to 08:30 PM, Monday through Saturday. Closed on Sundays."
        }
      ],
      similarListings: []
    };
  ...
  list.forEach(item => {
    item.similarListings = list.filter(l => l.id !== item.id).map(l => ({
      id: l.id,
      name: l.name,
      location: l.location,
      rating: l.rating,
