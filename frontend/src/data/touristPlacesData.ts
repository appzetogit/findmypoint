...
export const touristPlacesData: Record<string, TouristPlaceDetailData> = {
  Ujjain: {
    ...
    description:
      "Ujjain is one of the holiest cities in Hinduism, located on the banks of the Shipra River in Madhya Pradesh. Famous for the Mahakaleshwar Jyotirlinga temple, it is one of the four sites for the Kumbh Mela pilgrimage. Steeped in history, spirituality, and ancient Indian astronomy, Ujjain attracts millions of seekers and tourists annually.",
    categories: [
      { name: "Temples", icon: "🕌" },
      { name: "Hotels", icon: "🏨" },
    ...
    temples: [
      {
        ...
        reviewsCount: 1540,
        image:
          "https://images.unsplash.com/photo-1627896157734-4d7d4388f24b?auto=format&fit=crop&w=500&q=80",
      ...
      },
      {
        ...
        reviewsCount: 920,
        image:
          "https://images.unsplash.com/photo-1601999109332-542b18dbec57?auto=format&fit=crop&w=500&q=80",
    ...
    faqs: [
      {
        ...
        answer:
          "The best time to visit Ujjain is from October to March when the weather is pleasant. Devotees also flock during Shravan month (July-August) and Kartik Mela.",
      },
      {
        question: "How can I book Bhasma Aarti at Mahakaleshwar Temple?",
        answer:
          "Bhasma Aarti can be booked online via the official Ujjain Mahakaleshwar Temple website (up to 30 days in advance) or offline at the counter one day prior on a first-come, first-served basis.",
      },
      {
        question: "What famous dishes should I try in Ujjain?",
        answer:
          "Do not miss Ujjaini Sev, Kachoris, Poha-Jalebi, and Rabdi at Tower Chowk and local street food hubs.",
      },
    ],
  },
  Udaipur: {
    ...
    description:
      "Known as the 'City of Lakes' and the 'Venice of the East', Udaipur is a picturesque historic capital of the Mewar Kingdom in Rajasthan. Surrounded by the beautiful Aravalli Hills, it is famous for its stunning lakes, majestic palaces, gorgeous gardens, and rich cultural heritage.",
    categories: [
      { name: "Sightseeing", icon: "📸" },
      { name: "Hotels", icon: "🏨" },
      { name: "Food Point", icon: "🍲" },
    ...
    hotels: [
      {
        ...
        reviewsCount: 890,
        image:
          "https://images.unsplash.com/photo-1562280963-8a54756e04da?auto=format&fit=crop&w=500&q=80",
    ...
    faqs: [
      {
        ...
        answer:
          "Usually 2 to 3 days are sufficient to cover major attractions like City Palace, Lake Pichola, Sajjangarh Monsoon Palace, and Saheliyon-ki-Bari.",
      },
    ],
  },
  Ahmedabad: {
    ...
    description:
      "Ahmedabad is Gujarat's largest city and India's first UNESCO World Heritage City. Located on the banks of the Sabarmati River, it is famous for its Gandhi heritage (Sabarmati Ashram), spectacular architecture (Adalaj Stepwell), vibrant textiles, and delicious Gujarati cuisine.",
    categories: [
      { name: "Sightseeing", icon: "📸" },
      { name: "Hotels", icon: "🏨" },
      { name: "Food Point", icon: "🍲" },
    ...
    activities: [
      {
        ...
        reviewsCount: 2800,
        image:
          "https://images.unsplash.com/photo-1599830889502-36c535728a50?auto=format&fit=crop&w=500&q=80",
    ...
    faqs: [
      {
        ...
        answer:
          "Yes, Ahmedabad is consistently ranked as one of the safest cities in India for tourists and residents alike.",
      },
    ],
  },
  Nashik: {
    ...
    description:
      "Nashik is an ancient holy city in Maharashtra, situated on the banks of the Godavari River. Known as the 'Wine Capital of India' due to its numerous vineyards, Nashik is also famous for hosting the Kumbh Mela and its linkages with the Hindu epic Ramayana.",
    categories: [
      { name: "Temples", icon: "🕌" },
      { name: "Hotels", icon: "🏨" },
      { name: "Food Point", icon: "🍲" },
    ...
    faqs: [
      {
        ...
        answer:
          "Yes, Trimbakeshwar is about 28 km (approx. 45-50 minutes drive) from main Nashik city.",
      },
    ],
  },
  Jaipur: {
    ...
    faqs: [
      {
        ...
        answer:
          "In 1876, Maharaja Sawai Ram Singh ordered the entire city to be painted pink (the color of hospitality) to welcome Albert Edward, Prince of Wales.",
      },
    ],
  },
  ...
  Mumbai: {
    ...
    description:
      "Mumbai, the City of Dreams, is India's financial, commercial, and entertainment capital. Perched on the Arabian Sea coast, it boasts iconic landmarks like the Gateway of India, Marine Drive's Queen's Necklace, and the vibrant Dharavi. A melting pot of cultures, it offers world-class dining, heritage architecture, Bollywood studios, and a nightlife that never sleeps.",
    categories: [
    ...
    temples: [
      {
        ...
        reviewsCount: 12400,
        image:
          "https://images.unsplash.com/photo-1567157577867-05ccb1388e66?auto=format&fit=crop&w=500&q=80",
      ...
      },
      {
        ...
        reviewsCount: 5300,
        image:
          "https://images.unsplash.com/photo-1529253355930-ddbe423a2ac7?auto=format&fit=crop&w=500&q=80",
    ...
    faqs: [
      {
        ...
        answer:
          "October to February is the best time to visit Mumbai, when the weather is pleasant and cooler. Monsoon season (June-September) makes the city lush green but heavy rains can disrupt travel.",
      },
      {
        question: "How do I get around Mumbai?",
        answer:
          "Mumbai has an excellent local train network (Western, Central, and Harbour lines) which is the fastest way to travel. Auto-rickshaws operate in the suburbs, while taxis and app cabs like Ola/Uber are available citywide.",
      },
      {
        question: "What is Mumbai famous for?",
        answer:
          "Mumbai is famous for being India's financial capital, home of Bollywood (Hindi film industry), street food like Vada Pav and Pav Bhaji, Marine Drive, the Gateway of India, and its incredibly diverse and resilient spirit.",
      },
    ],
  },
};
