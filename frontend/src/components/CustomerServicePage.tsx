    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-xs text-muted-foreground mt-0.5">
          Solve queries dynamically or submit a support message.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-stretch">
        ...
        <div className="md:col-span-5 space-y-4 bg-secondary/15 border border-border/50 rounded-2xl p-5 flex flex-col justify-between text-left">
          <div>
            <span className="text-[10px] font-black uppercase text-primary tracking-wider block mb-3">
              Support Contacts
            </span>
          ...
          <div className="border-t border-border/40 pt-4 text-[10px] font-semibold text-muted-foreground leading-relaxed text-left">
            💡 Our support desk is dedicated to assisting you with table reservation cancellations,
            receipt prints, and profile settings inquiries.
          </div>
        </div>
        ...
        <form
          ...
          className="md:col-span-7 bg-card border border-border rounded-2xl p-5 md:p-6 space-y-4 shadow-sm flex flex-col justify-between"
        >
          <span className="text-[10px] font-black uppercase text-primary tracking-wider block text-left">
            Send us a Message
          </span>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="text-left">
              ...
              <input
                ...
                onChange={(e) =>
                  dispatch({ type: "CHANGE_FIELD", field: "contactName", value: e.target.value })
                }
            ...
            <div className="text-left">
              ...
              <input
                ...
                onChange={(e) =>
                  dispatch({ type: "CHANGE_FIELD", field: "contactEmail", value: e.target.value })
                }
          ...
          <div className="text-left">
            ...
            <input
              ...
              onChange={(e) =>
                dispatch({ type: "CHANGE_FIELD", field: "contactSubject", value: e.target.value })
              }
          ...
          <div className="text-left">
            ...
            <textarea
              ...
              onChange={(e) =>
                dispatch({ type: "CHANGE_FIELD", field: "contactMessage", value: e.target.value })
              }
