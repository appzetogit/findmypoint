...
export const articlesData: ArticleData[] = [
  {
    ...
    views: "1.2k views",
    commentsCount: 8,
    mainImage: "https://images.unsplash.com/photo-1556910103-1c02745aae4d?auto=format&fit=crop&w=1200&q=80",
    galleryImages: [
    ...
    businesses: [
      {
        ...
        description: "DecoCraft Architects is known for bringing minimalist European designs to Indore. They focus on clean lines, neutral colors, and maximizing natural light. Whether it's a modular kitchen or a complete living space overhaul, their attention to details is unmatched.",
        quote: "They turned our old 3BHK flat into a spacious, modern oasis. Highly professional team!",
    ...
    businesses: [
      {
        ...
        description: "Glam & Glow Studio, managed by senior artist Ritu Pal, is highly recommended for Airbrush and HD bridal makeup. They offer customized packages including hair styling, draping, and nail extension. They use premium international brands like MAC, NARS, and Huda Beauty.",
        quote: "Loved my bridal makeup! It stayed fresh all night, and I received so many compliments.",
