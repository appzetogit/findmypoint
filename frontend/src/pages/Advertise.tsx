...
function advertiseReducer(
  state: AdvertiseFormState,
  action: AdvertiseFormAction,
): AdvertiseFormState {
  switch (action.type) {
    case "CHANGE_FIELD":
        ...
        {state.submitted ? (
          <div className="max-w-xl mx-auto text-center bg-white border border-slate-200/85 rounded-3xl p-8 md:p-12 shadow-2xl animate-scale-up">
            ...
            <p className="text-slate-600 text-sm leading-relaxed mb-6 font-medium">
              Thank you for choosing FindMyPoint to accelerate your growth. Our business relations
              manager will contact you on{" "}
              <span className="font-black text-primary">+91 {state.mobile}</span> within the next 24
              hours to set up your Premium listing.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-8 text-left">
              ...
              <form
                ...
                className="bg-white border border-slate-200 shadow-xl rounded-3xl p-6 sm:p-8 space-y-5"
              >
              ...
              <div className="space-y-3.5 bg-slate-100/60 border border-slate-200/40 rounded-2xl p-5">
                {[
                  ...
                  <div key={idx} className="flex items-start gap-3">
                    ...
                    <span className="text-xs sm:text-[13px] font-bold text-slate-700 leading-normal">
                      {text}
                    </span>
                  </div>
                ))}
              ...
              <div className="relative bg-slate-900 p-3 rounded-[3rem] shadow-2xl border-4 border-slate-800 w-[270px] sm:w-[290px] aspect-[9/18.5] flex flex-col overflow-hidden group hover:scale-[1.02] transition-transform duration-500">
                ...
                <div className="bg-white flex-1 rounded-[2.2rem] overflow-hidden flex flex-col p-4 pt-8 text-left space-y-4">
                  ...
                  <div className="border border-slate-200 rounded-full px-3 py-1.5 flex items-center justify-between shadow-sm bg-slate-50">
                    ...
                    <div className="h-4.5 w-4.5 rounded-full bg-primary flex items-center justify-center text-white text-[8px] font-bold">
                      🔍
                    </div>
                  </div>
                  ...
                  <div className="border border-primary bg-blue-50/20 rounded-xl p-3.5 space-y-2 relative shadow-[0_4px_16px_rgba(0,98,255,0.06)] animate-pulse">
                    <span className="absolute top-2 right-2 text-[8px] font-extrabold uppercase bg-primary text-white px-1.5 py-0.5 rounded tracking-wider shadow-sm">
                      SPONSORED
                    </span>
                    ...
                    <p className="text-[9px] text-slate-500 leading-normal font-medium">
                      Top-rated specialist in {city}. Guaranteed call and fast booking support.
                    </p>

                    <div className="flex gap-1.5 pt-1">
                      <button className="flex-1 bg-primary text-white text-[8px] font-black py-1.5 rounded-lg text-center cursor-pointer shadow-sm">
                        Call Now
                      </button>
                      <button className="flex-1 border border-primary/25 text-primary text-[8px] font-bold py-1.5 rounded-lg text-center">
                        Inquire
                      </button>
                    </div>
                  </div>
                  ...
                  <div className="border border-slate-100 rounded-xl p-3 space-y-2 opacity-55">
                    <div className="flex items-center gap-2">
                      <div className="h-7 w-7 rounded-lg bg-slate-100 flex items-center justify-center text-slate-400 text-xs font-bold">
                        🏢
                      </div>
                      <div className="flex flex-col">
