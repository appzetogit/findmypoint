    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-xs text-muted-foreground mt-0.5">
          These categories are prioritized on your dashboard to customize suggestions.
        </p>
      </div>
      ...
      <div className="pt-4 border-t border-border/50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {mockRecommended.map((rec) => (
            <div
              key={rec.id}
              className="p-4 bg-card border border-border rounded-2xl shadow-sm flex items-center justify-between hover:border-primary/20 transition-all duration-300"
            >
